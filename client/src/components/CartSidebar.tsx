...
const CartSidebar = () => {
  ...
  const deliveryFee = cartTotal > 3000 ? 0 : 300;
          ...
          <div className="p-5 border-t border-app-border space-y-3">
            ...
            {deliveryFee > 0 && (
              <p className="text-xs text-app-text-light text-center">
                Free delivery on orders over 3000 {currency}
              </p>
            )}
            ...
            <button
              onClick={() => {
                ...
                navigate("/checkout");
                window.scrollTo(0, 0);
              }} // Fixed: Cleaned split paths inside navigate strings
              className="w-full py-3 bg-app-orange text-white font-semibold rounded-xl hover:bg-app-orange-dark transition-colors flex items-center justify-center gap-2 active:scale-[0.98]" // Fixed: Swapped custom flex-center out for default Tailwind properties
            >
