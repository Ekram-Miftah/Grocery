...
const Hero = () => {
  return (
    <section
      className="relative overflow-hidden min-h-[540px] mb-10
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-linear-to-r from-app-green
          via-app-green/65 to-transparent"
      />
      <div
...
lg:px-8 py-20 w-full"
    ...
    py-1.5 text-xs font-semibold text-orange-300
...
mb-8 max-w-md"
  ...
  10 text-white font-semibold rounded-full
  hover:bg-white/20 transition-all border
  border-white/20"
            >
              Browse Categories
            </Link>
