...
const REVIEWERS = [
  { name: "Abebe S.", avatar: "AS" },
  { name: "Roza M.", avatar: "RM" },
  { name: " Peter K.", avatar: "PK" },
  { name: "Ekram J.", avatar: "VJ" },
  { name: "Mera D.", avatar: "MD" },
  { name: "Ahmed R.", avatar: "AR" },
  { name: "Sena T.", avatar: "ST" },
  { name: "Kaldidan P.", avatar: "KP" },
];
