...
export const categoriesData = [
  ...
  { slug: "personal-care", name: "የግል እንክብካቤ", image: personal_care },
  { slug: "pantry-staples", name: "መሰረታዊ ምግቦች", image: pantry_staples },
  { slug: "bakery", name: "የዳቦና ኬክ ምርቶች", image: bakery },
  { slug: "beverages", name: "መጠጦች", image: drinks },
  { slug: "meat-seafood", name: "ስጋና የባህር ምግቦች", image: meat_seafood },
  { slug: "snacks", name: "ቀላል ምግቦች / መክሰስ", image: snacks },
  { slug: "frozen-foods", name: "በረዶ የቀዘቀዙ ምግቦች", image: frozen_foods },
  { slug: "baby-care", name: "የህፃናት እንክብካቤ", image: baby_care },
  { slug: "dairy-eggs", name: "የወተት ተዋጽኦና እንቁላል", image: dairy_eggs },
];

export const heroSectionData = {
  description:
    "ኦርጋኒክ ምርቶች ከእርሻ ወደ ደጃፍዎ። ጥራት እና ምቾት በአንድ ላይ።ሊቀምሱት የሚችሉት ጥራት፣ የሚገባዎት ምቾት።",
  hero_image: hero_bg,
  hero_features: [
    { icon: TruckIcon, title: " ነፃ የቤት ማድረሻ", desc: "ከ3000 ብር በላይ " },
    { icon: LeafIcon, title: "100% ኦርጋኒክ", desc: "Certified products" },
