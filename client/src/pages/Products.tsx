...
const Products = () => {
  ...
  transition-colors"
                ...
                <div className="relative">
                  <select
                    ...
                    className="appearance-none pl-3 pr-8 py-2 text-sm
  ...
  focus:border-app-green outline-none cursor-pointer"
                  ...
                  <ChevronDown
                    className="absolute right-2.5 top-1/2 -translate-y-1/
2 w-3.5 h-3.5 text-app-text-light pointer-events-none"
                  />
                </div>
              </div>
            </div>
